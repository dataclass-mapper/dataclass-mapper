...
def test_pydantic_has_no_validators():
    ...
    assert PydanticClassMeta.from_clazz(Pydantic1, namespace=empty_namespace).use_construct
...
def test_pydantic_has_validators():
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic1, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic2, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic3, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic4, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic5, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic6, namespace=empty_namespace).use_construct
    ...
    assert not PydanticClassMeta.from_clazz(Pydantic7, namespace=empty_namespace).use_construct
